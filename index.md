...
[Dockerfile](https://github.com/retrage/edk2-nightly/blob/master/Dockerfile)
and reusable workflows.
Workflows run for pull requests, pushes to `master`, and a nightly build at 00:00 UTC.
Please see
[ci.yml](https://github.com/retrage/edk2-nightly/blob/master/.github/workflows/ci.yml),
[reusable-build-firmware.yml](https://github.com/retrage/edk2-nightly/blob/master/.github/workflows/reusable-build-firmware.yml),
[reusable-build-shell.yml](https://github.com/retrage/edk2-nightly/blob/master/.github/workflows/reusable-build-shell.yml),
and
[docker-image.yml](https://github.com/retrage/edk2-nightly/blob/master/.github/workflows/docker-image.yml)
for more details.
